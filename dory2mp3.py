...
def dory2mp3():
    ...
    playlist=Entry(tab1,width=50)
    playlist.place(rely=0.5, relx=0.5, x=0, y=-10, anchor=CENTER)
    ...
    btn1 = Button(tab1, text= 'Download 1 Song', command=setsong)

    btn1.place(rely=1.0, relx=0.75, x=0, y=0, anchor=SE)

    lbl_j = Label(tab2,text= "Created for my beloved dory")
    lbl_j.place(rely=0.4, relx=0.6, x=0, y=0, anchor=CENTER)
